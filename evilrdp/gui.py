...
class EvilRDPGUI(QMainWindow):
	...
	#	modmap = {
	#		Qt.KeyboardModifier.ControlModifier: keymap[Qt.Key.Key_Control],
	#		Qt.KeyboardModifier.AltModifier: keymap[Qt.Key.Key_Alt],
	#		Qt.KeyboardModifier.ShiftModifier: keymap[Qt.Key.Key_Shift],
	#		Qt.KeyboardModifier.MetaModifier: keymap[Qt.Key.Key_Meta],
	#		Qt.KeyboardModifier.GroupSwitchModifier: keymap[Qt.Key.Key_AltGr],
	#		Qt.KeyboardModifier.KeypadModifier: keymap[Qt.Key.Key_NumLock],
	#		}
	#	sequence = []
